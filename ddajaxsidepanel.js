...
var ddajaxsidepanel = {
	defaults: {ajaxloadgif:'squareloading.gif', fx:{dur:'normal', easing:'swing'}, openamount:'80%', openamount_minthreshold:'380px'},
...
jQuery(function(){
	ddajaxsidepanel.init({
		...
		openamount_minthreshold:'380px' //Minimum required width of panel (when fully opened)  before panel is shown. This prevents panel from being shown on small screens or devices.
	})
});